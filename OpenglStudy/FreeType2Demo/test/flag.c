...
static int make_flag_program(
    ...
    *vertex_shader = make_shader(GL_VERTEX_SHADER, "/Users/chukie/wheel/OpenglStudy/flag.v.glsl");
    if (*vertex_shader == 0)
        return 0;
    *fragment_shader = make_shader(GL_FRAGMENT_SHADER, "/Users/chukie/wheel/OpenglStudy/flag.f.glsl");
...
static int make_resources(void)
{
    ...
    g_resources.flag.texture = make_texture("/Users/chukie/wheel/OpenglStudy/flag.tga");
    g_resources.background.texture = make_texture("/Users/chukie/wheel/OpenglStudy/background.tga");
